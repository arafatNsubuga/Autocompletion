...
- Use locales when doing the comparisons, instead of the simple lexicographic order, so that e.g. *a*, *á* and *A* are all treated as equal, but *a* and *ä* are not. See the lecture slides on comparators for more information.

<!--See the [tutorial on comparators](https://chalmers.instructure.com/courses/10681/pages/comparables-and-comparators) for more information.
-->
